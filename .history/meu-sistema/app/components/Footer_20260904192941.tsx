            ...
            <div>
                ...
                <div>
                    ...
                    <nav className="flex flex-col gap-1 text-sm">
                        <Link href="/inicio" className="hover: text-orange-800 transition-colors">Inicio</Link>
                        <Link href="/cardapio" className="hover: text-orange-800 transition-colors">Cardápio Completo</Link>
                        <Link href="/categoria" className="hover: text-orange-800 transition-colors">Categorias</Link>
                    </nav>
                </div>
