...
export default function PaginaCardapio() 
{
    ...
    descricao: "Fatias de pão italiano tostado com tomate fresco, mussarela de búfala emanjericão",
    preco: 120,
    // 🟢 CORRIGIDO: Removidos os caracteres '<' e '>'
    ...
    descricao: "Filé mignon grelhado ao ponto, servido com molho madeira e batatas
    rústicas",
    preco: 78.9,
    // 🟢 CORRIGIDO: Removidos os caracteres '<' e '>'
