import { editarPrato } from "../../actions";
            ...
            >
                ...
                <label className="flex items-center gap-2 p-2">
                    <input
                        name="destacado"
                        type="checkbox"
                        defaultChecked={prato.destacado}
                ...
                <button
                    type="submit"
                    className="bg-blue-600 text-white p-4 rounded-xl font-bold hover:bg-blue-700"
                >
                    Atualizar Prato
                </button>
            </form>
